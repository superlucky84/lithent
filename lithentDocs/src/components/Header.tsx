...
import { appStore, toggleTheme, navigateTo, setLanguage } from '@/store';
          ...
          <div class="flex h-16">
            ...
            <div class="flex-1 w-full min-w-0 px-6 md:px-12">
              <div class="max-w-full md:max-w-[43rem] flex items-center justify-end h-16">
                ...
                {/* Language toggle */}
                <div class="flex items-center ml-4 border border-gray-200 dark:border-gray-700 rounded-full text-xs font-semibold overflow-hidden">
                  <button
                    type="button"
