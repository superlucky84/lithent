      ...
      <div class="mx-auto max-w-[1440px] px-6 md:px-12 lg:px-0">
        <div class="flex h-16 items-center justify-between lg:pl-6 lg:pr-12">
          ...
          <div class="flex items-center gap-6">
            ...
            <button
              onClick={toggleTheme}
              class="relative inline-flex items-center h-9 w-16 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[#42b883] focus:ring-offset-2 bg-gray-200 dark:bg-gray-700"
