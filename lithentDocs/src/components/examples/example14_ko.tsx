...
export const Example14Ko = mount(r => {
  ...
  return () => (
    <div class="w-full max-w-3xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="mt-4 p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 col-span-1 md:col-span-2">
        ...
        <div class="mt-4 p-3 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 col-span-1 md:col-span-2">
