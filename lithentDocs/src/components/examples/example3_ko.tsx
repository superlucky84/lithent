...
const MouseTrackerKo = mount<MouseTrackerProps>(renew => {
...
// 좌표 정보 표시
const CoordinateDisplayKo = mount(_r => {
...
const ColorfulBackgroundKo = mount(_r => {
  return ({ pos }: { pos: MousePosition }) => {
...
export const Example3Ko = mount((renew: any) => {
