...
const code10 = `<script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/dist/lithent.umd.js"></script>
<!--script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/helper/dist/lithentHelper.umd.js"></script-->
<script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/ftags/dist/lithentFTags.umd.js"></script>
...
const code7 = `<script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/dist/lithent.umd.js"></script>
<!--script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/helper/dist/lithentHelper.umd.js"></script-->
<script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/tag/dist/lithentTag.umd.js"></script>
<!--script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/ftags/dist/lithentFTags.umd.js"></script-->
...
const code9 = `<script src="https://cdn.jsdelivr.net/npm/lithent@1.17.3/tag/dist/lithentTag.umd.js"></script>;
const { lTag } = lithentTag;
const destroy = render(lTag\`<\${Component} />\`, document.getElementById('root'));
`;
  ...
  return () => (
    <div class="max-w-3xl px-4 pt-6 xl:gap-4 bg-gray-900">
      ...
      <div class="px-2 py-2 overflow-x-auto text-sm text-gray-50 border border-gray-200 border-dashed rounded border-gray-600 bg-black">
        <p> </p>
        <p>## umd</p>
        <p>https://cdn.jsdelivr.net/npm/lithent@1.17.3/dist/lithent.umd.js</p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.17.3/helper/dist/lithentHelper.umd.js
        </p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.17.3/ftags/dist/lithentFTags.umd.js
        </p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.17.3/tag/dist/lithentTag.umd.js
        </p>
        <p>&nbsp;</p>
        <p>## esm</p>
        <p>https://cdn.jsdelivr.net/npm/lithent@1.17.3/dist/lithent.mjs</p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.17.3/helper/dist/lithentHelper.mjs
        </p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.17.3/ftags/dist/lithentFTags.mjs
        </p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.17.3/tag/dist/lithentTag.mjs
        </p>
      </div>
