...
const code7 = `<script src="https://cdn.jsdelivr.net/npm/lithent@1.0.7/dist/lithent.umd.js"></script>
...
export const Install = mount(() => {
  ...
  return () => (
    <div class="max-w-3xl px-4 pt-6 xl:gap-4 bg-gray-900">
      ...
      <div class="px-2 py-2 overflow-x-auto text-sm text-gray-50 border border-gray-200 border-dashed rounded border-gray-600 bg-black">
        <p>https://cdn.jsdelivr.net/npm/lithent@1.0.7/dist/lithent.umd.js</p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.0.7/helper/dist/lithentHelper.umd.js
        </p>
        <p>https://cdn.jsdelivr.net/npm/lithent@1.0.7/dist/lithent.mjs</p>
        <p>
          https://cdn.jsdelivr.net/npm/lithent@1.0.7/helper/dist/lithentHelper.mjs
        </p>
      </div>
