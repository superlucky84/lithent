...
const DataLoader = mount((renew) => {
  ...
  return () => (
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      이 예제는 DOM이 생성되기 전에 데이터 로딩을 시작하여, 초기 렌더링
      성능을 개선할 수 있습니다.
    </p>
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      전역 상태 관리 스토어 구독은 DOM과 무관하므로 mountReadyCallback을
      사용할 수 있습니다.
    </p>
    ...
    <div class="border-l-4 border-[#42b883] bg-gradient-to-r from-[#42b883]/5 to-transparent dark:from-[#42b883]/10 dark:to-transparent p-6 mb-6 rounded-r">
      <ol class="space-y-3 text-sm md:text-base text-gray-700 dark:text-gray-300">
        <li class="flex items-start">
          ...
          <span>
            마운터 실행 시 mountReadyCallback 호출로 콜백 함수 등록 (아직
            실행 안 됨)
          </span>
        </li>
        <li class="flex items-start">
        ...
        <li class="flex items-start">
          ...
          <span>
            Virtual DOM 생성 직후, 등록된 mountReadyCallback 함수들을
            순서대로 실행
          </span>
        </li>
        <li class="flex items-start">
...
// Cleanup: mountReadyCallback`}
    ...
    <div class="border-l-4 border-yellow-500 bg-yellow-50 dark:bg-yellow-900/20 p-4 mb-6 rounded-r">
      <p class="text-sm md:text-base text-yellow-800 dark:text-yellow-200 leading-relaxed">
        ...
        mountReadyCallback은 마운터 내부에서만 호출해야 합니다. Updater나
        이벤트 핸들러에서 호출하면 안 됩니다.
      </p>
    </div>
    ...
    <div class="border-l-4 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/50 p-4 mb-6 rounded-r">
      <p class="text-sm md:text-base text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <br />
        데이터 프리페치, 스토어 구독, 분석 초기화 등 특수한 경우에만
        사용하세요.
        <br />
        <br />
    ...
    <div class="grid gap-6 mt-6">
      ...
      >
        ...
        <p class="text-sm md:text-base text-gray-700 dark:text-gray-300">
          DOM 요소에 직접 접근하는 ref에 대해 알아보세요.
          <br />
          외부 라이브러리 연동이나 DOM 조작이 필요한 경우 ref를 사용하는
          방법을 배워봅시다.
        </p>
      </a>
    </div>
