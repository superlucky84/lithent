...
export const Aside = mount<{ isHidden: boolean }>(renew => {
  const shardStore = assignSharedStore(renew);
  const pathState = computed(() => normalizePath(shardStore.path));

  const navigate = (event: Event, path: string) => {
    event.preventDefault();
    setPath(shardStore, path, { push: true });
  };
          ...
          <div class="flex-1 px-3 space-y-1 divide-y divide-gray-200 bg-gray-800 divide-gray-700">
            <ul class="pb-2 space-y-2">
              ...
              >
                <a
                  href="/main/install"
                  onClick={(event: Event) => navigate(event, '/main/install')}
              ...
              <li
                class={
                  !['/main/install', '/main/examples', '/main/about'].includes(
                    pathState.v
                  )
                    ? 'border border-gray-200 border-dashed rounded'
                    : ''
              ...
              >
                <a
                  href="/main"
                  onClick={(event: Event) => navigate(event, '/main')}
              ...
              >
                <a
                  href="/main/examples"
                  onClick={(event: Event) => navigate(event, '/main/examples')}
                  class="flex items-center p-2 text-base transition duration-75 rounded-lg hover:bg-gray-100 group text-gray-200 hover:bg-gray-700"
                >
                  <svg
                    class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 text-gray-400 group-hover:text-white"
              ...
              >
                <a
                  href="/main/about"
                  onClick={(event: Event) => navigate(event, '/main/about')}
                  class="flex items-center p-2 text-base transition duration-75 rounded-lg hover:bg-gray-100 group text-gray-200 hover:bg-gray-700"
                >
                  <svg
